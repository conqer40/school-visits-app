...
import { addSchoolAction, editSchoolAction } from "./actions";
...
export default function SchoolsClientPage({ 
  initialSchools, 
  ...
  const schoolToEdit = initialEditId ? schools.find((s: any) => s.id === initialEditId) : null;
